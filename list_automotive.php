...
<html>
  <head>
    <title>JHU SSEP automotive list </title>
        ...
        <div class="choice_btn choice_list" >          
          ...
          <table id="myTable">
            ...
            <script>
              ...
              numberlist("Sell my car bought last year","list_automotive_car.php",10000,3,2);
              numberlist("Sell my car bought last year","list_automotive_car.php",11000,1,1);
              numberlist("Sell my car bought last year","list_automotive_car.php",12000,2,9);
              numberlist("Sell my car bought last year","list_automotive_car.php",13000,9,9);
              numberlist("Sell my car bought last year","list_automotive_car.php",14000,10,10);
              
              //we only provide a template, all contents are randomed achieved, things change every fresh.
              randomlist("Sell my car bought last year","list_automotive_car.php",10000);
            </script>
