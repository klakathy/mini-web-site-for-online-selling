     ...
     <div id="top" class="container">
      ...
      <div class="container_content">
        <div class="choice_btn  choice_image">
          <img src="images/apartment.jpg" alt="image loading failure" title="apartment photo"/>
          <div>
            <h1>Looking for Sublease This Summer</h1>
            <h2>Perfered Price: $800-$1000</h2>
            <h3>Provided by: EFG</h3>
          </div>
      </div>
    </div>
    ...
    <div id="description" class="container">
      ...
      <div style="background-color: white;min-width: 700px;">
        <div class="choice_btn" style="padding: 20px 10%;">
          <h3>Description</h3>
          <p>I need to find a 1B1B apartment during this May to August. I hope that the apartment is located in Crystal City, Virginia. It would be better if the apartment is near to the Metro Station. It would be ideal if the washer and dryer are within the apartment. Price could be negotiate. </p>
          <p>If you have any furniture that I could use, I would also like to look at them and buy them.</p>
    ...
    <div id="picture" class="container">
      ...
      <div style="background-color: white;min-width: 700px;">
        <div class="choice_btn" style="padding: 20px 10%;">
          ...
          <p><img src="images/apartment.jpg" title="apartment photo" alt="image loading failure" width="400" onclick="size(this)"/></p>
          <p><img src="images/outside.jpg" title="apartment outside photo" alt="image loading failure" width="400" onclick="size(this)"/></p> 
        </div>
      </div>
      <!--end--><div class="container-end"></div>
    </div>
    ...
    <div id="post" class="container">
      ...
      <div style="background-color: white;min-width: 700px;">
        <div class="choice_btn" style="padding: 20px 10%;">
          ...
          <p>This entry is posted by <a href="ABC.php">EFG</a></p>
    ...
    <div id="purchase" class="container">
      ...
      <div style="background-color: white;min-width: 700px;">
        <div class="choice_btn" style="padding: 20px 10%;">
          ...
          <hr/>
          <p>Price: <b>$800-$1000</b></p>
          <p><i>Writer says: </i><br/>Remeber that price could negotiat. Welcom to contact me.</p>
          <hr/>
